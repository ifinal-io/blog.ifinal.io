...
var rgbaColor = function rgbaColor() {
  var color = arguments.length > 0 && arguments[0] !== undefined ? arguments[0]
      : '#fff';
  var alpha = arguments.length > 1 && arguments[1] !== undefined ? arguments[1]
      : 0.5;
...
var isScrolledIntoView = function isScrolledIntoView(el) {
  ...
  return {
    all: top >= window.pageYOffset && left >= window.pageXOffset && top + height
        <= window.pageYOffset + window.innerHeight && left + width
        <= window.pageXOffset + window.innerWidth,
    partial: top < window.pageYOffset + window.innerHeight && left
...
var setCookie = function setCookie(name, value, expire) {
  ...
  document.cookie = "".concat(name, "=").concat(value, ";expires=").concat(
      expires.toUTCString());
};
...
var getStoreSpace = function getStoreSpace() {
  var store = arguments.length > 0 && arguments[0] !== undefined ? arguments[0]
      : localStorage;
  return parseFloat(
      (escape(encodeURIComponent(JSON.stringify(store))).length / (1024
          * 1024)).toFixed(2));
};
...
var BulkSelect = /*#__PURE__*/function () {
  ...
  _createClass(BulkSelect, [{
    ...
    value: function attachNodes() {
      ...
      this.bulkSelectRows = document.getElementById(body).querySelectorAll(
    ...
    value: function clickRowCheckbox() {
      ...
      this.bulkSelectRows.forEach(function (el) {
        ...
        rowCheck.on('click', function () {
          ...
          if (_toConsumableArray(_this2.bulkSelectRows).every(
              function (element) {
...
var chatInit = function chatInit() {
  ...
  var $currentChatArea = document.querySelector(
      Selector.CHAT_CONTENT_SCROLL_AREA); // Set scrollbar position
  ...
  $chatEmojiarea && document.querySelectorAll(Selector.BTN_INFO).forEach(
      function (el) {
        el.addEventListener(Events.CLICK, function (e) {
          var $this = e.currentTarget;
          var dataIndex = utils.getData($this, DATA_KEY.INDEX);
          var $info = document.querySelector(
              "".concat(Selector.CONVERSATION_INFO, "[data-").concat(
                  DATA_KEY.INDEX, "='").concat(dataIndex, "']"));
  ...
  $chatEmojiarea && window.picker.on(Events.EMOJI, function (selection) {
    document.querySelector(
        Selector.EMOJIEAREA_EDITOR).innerHTML += selection.emoji;
  });
};
/* -------------------------------------------------------------------------- */
...
var cookieNoticeInit = function cookieNoticeInit() {
  ...
  notices.forEach(function (item) {
    ...
    item.addEventListener(Events.HIDDEN_BS_TOAST, function (e) {
      ...
      toastOptions.showOnce && utils.setCookie('notice', false,
...
var dropdownMenuInit = function dropdownMenuInit() {
  ...
  if (window.is.ios()) {
    ...
    document.querySelectorAll(Selector.TABLE_RESPONSIVE).forEach(
        function (table) {
...
var dropdownOnHover = function dropdownOnHover() {
  ...
  if (navbarArea) {
    navbarArea.addEventListener('mouseover', function (e) {
      if (e.target.className.includes('dropdown-toggle') && window.innerWidth
          > 992) {
  ...
  !!dropzones.length && dropzones.forEach(function (item) {
      ...
      init: function init() {
        ...
        thisDropzone.on(Events.ADDED_FILE, function addedfile() {
          if ('maxFiles' in userOptions) {
            if (userOptions.maxFiles === 1 && item.querySelectorAll(
                Selector.DZ_PREVIEW_COVER).length > 1) {
    ...
    dropzone.on(Events.ADDED_FILE, function () {
      if (item.querySelector(Selector.DZ_PREVIEW_COVER)) {
        item.querySelector(Selector.DZ_PREVIEW_COVER).classList.remove(
...
var renderCalendar = function renderCalendar(el, option) {
  ...
  calendar.render();
  document.querySelector('.navbar-vertical-toggle').addEventListener(
      'navbar.vertical.toggle', function () {
  ...
  if ($googlemaps.length && window.google) {
    ...
    $googlemaps.forEach(function (itm) {
      ...
      if (utils.getData(itm, 'theme') === 'streetview') {
        ...
        return new window.google.maps.StreetViewPanorama(mapElement,
            _mapOptions);
      }
      ...
      var mapOptions = {
        ...
        styles: localStorage.getItem('theme') === 'dark' ? mapStyles.Cobalt
            : mapStyles[mapStyle]
      };
    ...
    iconList.addEventListener('click', function (e) {
      ...
      if (el.tagName === 'INPUT') {
        ...
        iconCopiedToast.querySelector(
            '.toast-body').innerHTML = "<span class=\"fw-black\">Copied:</span> <code>".concat(
            el.value, "</code>");
...
var kanbanInit = function kanbanInit() {
  ...
  var collapseDismissButtons = document.querySelectorAll(
      Selectors.BTN_COLLAPSE_DISMISS); // Show add card form and place scrollbar bottom of the list
...
var leafletActiveUserInit = function leafletActiveUserInit() {
  ...
  if (L && mapContainer) {
    var getFilterColor = function getFilterColor() {
      return localStorage.getItem('theme') === 'dark' ? ['invert:98%',
        'grayscale:69%', 'bright:89%', 'contrast:111%', 'hue:205deg',
        'saturate:1000%'] : ['bright:101%', 'contrast:101%', 'hue:23deg',
        'saturate:225%'];
    };
    ...
    points.map(function (point) {
      ...
      var popupContent = "\n        <h6 class=\"mb-1\">".concat(name,
          "</h6>\n        <p class=\"m-0 text-500\">").concat(street,
          ", ").concat(location, "</p>\n      ");
      var popup = L.popup({
        minWidth: 180
    ...
    themeController.addEventListener('clickControl', function (_ref9) {
      ...
      if (control === 'theme') {
        tiles.updateFilter(
            value === 'dark' ? ['invert:98%', 'grayscale:69%', 'bright:89%',
              'contrast:111%', 'hue:205deg', 'saturate:1000%'] : ['bright:101%',
              'contrast:101%', 'hue:23deg', 'saturate:225%']);
      }
    });
  }
};
...
var togglePaginationButtonDisable = function togglePaginationButtonDisable(button,
    disabled) {
    ...
    if (lists.length) {
      lists.forEach(function (el) {
        ...
        var updateListControls = function updateListControls() {
          listInfo && (listInfo.innerHTML = "".concat(list.i, " to ").concat(
              numberOfcurrentItems, " of ").concat(totalItem));
          paginationButtonPrev && togglePaginationButtonDisable(
              paginationButtonPrev, pageCount === 1);
          paginationButtonNext && togglePaginationButtonDisable(
              paginationButtonNext, pageCount === pageQuantity);
        ...
        if (paginationButtonNext) {
          paginationButtonNext.addEventListener('click', function (e) {
            ...
            nextInitialIndex <= list.size() && list.show(nextInitialIndex,
                itemsPerPage);
        ...
        if (options.pagination) {
          el.querySelector('.pagination').addEventListener('click',
              function (e) {
    ...
    if (windowWidth < navbarTopBreakpoint) {
      ...
      if (navbarTopContent) {
        ...
        if (navbarVerticalBreakpoint < navbarTopBreakpoint) {
          var navbarNav = document.querySelector(
              Selector.DATA_MOVE_CONTAINER).querySelector(Selector.NAVBAR_NAV);
      ...
      if (moveableContainer) {
        ...
        moveableContainer.querySelector(
            Selector.NAVBAR_VERTICAL_DIVIDER).remove();
        navbarTopCombo.querySelector(
            Selector.COLLAPSE).innerHTML = moveableContainer.innerHTML;
...
var navbarDarkenOnScroll = function navbarDarkenOnScroll() {
  ...
  if (navbar) {
    ...
    var defaultColorName = theme === 'dark' ? '100' : 'light';
    var parent = document.documentElement;
    var windowHeight = window.innerHeight;
    var html = document.documentElement;
    var navbarCollapse = navbar.querySelector(Selector.NAVBAR_COLLAPSE);

    var allColors = _objectSpread(_objectSpread({}, utils.getColors(parent)),
        utils.getGrays(parent));

    var name = utils.getData(navbar, DataKey.NAVBAR_DARKEN_ON_SCROLL);
    var colorName = Object.keys(allColors).includes(name) ? name
        : defaultColorName;
    ...
    utils.resize(function () {
      ...
      if (window.innerWidth > breakPoint) {
        ...
        navbar.style.backgroundImage = html.scrollTop ? backgroundImage
            : 'none';
        navbar.style.transition = 'none';
      } else if (!utils.hasClass(navbar.querySelector(Selector.NAVBAR_TOGGLER),
...
var navbarTopDropShadow = function navbarTopDropShadow() {
  ...
  if ($navbarVerticalCollapse) {
    $navbarVerticalCollapse.addEventListener(Events.HIDDEN_BS_COLLAPSE,
        function () {
          if (utils.hasClass($navbarVerticalCollapse, ClassNames.SHOW)
...
var handleNavbarVerticalCollapsed = function handleNavbarVerticalCollapsed() {
  ...
  if (navbarVerticalToggle) {
    navbarVerticalToggle.addEventListener(Events.CLICK, function (e) {
      ...
      utils.setItemToStore('isNavbarVerticalCollapsed',
          !isNavbarVerticalCollapsed);
      ...
      var getDefaultOptions = function getDefaultOptions() {
        return {
          ...
          step: function step(state, circle) {
            ...
            circle.setText("<span class='value'>".concat(percentage,
                "<b>%</b></span> <span>").concat(userOptions.text || '',
                "</span>"));
          }
        };
      };
...
var quantityInit = function quantityInit() {
  ...
  quantities.forEach(function (quantity) {
    quantity.addEventListener(Events.CLICK, function (e) {
      ...
      var numberInput = el.closest(Selector.DATA_QUANTITY).querySelector(
          Selector.DATA_QUANTITY_INPUT);
...
var scrollToTop = function scrollToTop() {
  document.querySelectorAll('[data-anchor] > a, [data-scroll-to]').forEach(
      function (anchor) {
        anchor.addEventListener('click', function (e) {
          ...
          window.scroll({
            top: (_utils$getData2 = utils.getData(el, 'offset-top')) !== null
            && _utils$getData2 !== void 0 ? _utils$getData2 : utils.getOffset(
                document.querySelector(id)).top - 100,
            left: 0,
            behavior: 'smooth'
          });
...
var scrollbarInit = function scrollbarInit() {
  Array.prototype.forEach.call(document.querySelectorAll('.scrollbar-overlay'),
      function (el) {
...
var searchInit = function searchInit() {
  ...
  searchAreas.forEach(function (searchArea) {
    ...
    btnDropdownClose && btnDropdownClose.addEventListener(Events.CLICK,
        function (e) {
  ...
  document.querySelectorAll(Selectors.DROPDOWN_TOGGLE).forEach(
      function (dropdown) {
...
var settingsPanelInit = function settingsPanelInit() {
  ...
  modals.forEach(function (item) {
    ...
    item.addEventListener('hidden.bs.modal', function (e) {
      ...
      modalOptions.showOnce && utils.setCookie('modal', false,
          modalOptions.cookieExpireTime);
    });
  });
};
/*-----------------------------------------------
...
var swiperInit = function swiperInit() {
  ...
  swipers.forEach(function (swiper) {
    ...
    if (thumbsOptions) {
      ...
      thumbs.innerHTML = "<div class='swiper-wrapper'>".concat(slides,
          "</div>");
    ...
    var newSwiper = new window.Swiper(swiper,
        _objectSpread(_objectSpread({}, options), {}, {
          navigation: {
            nextEl: swiperNav === null || swiperNav === void 0 ? void 0
                : swiperNav.querySelector('.swiper-button-next'),
            prevEl: swiperNav === null || swiperNav === void 0 ? void 0
...
var initialDomSetup = function initialDomSetup(element) {
  ...
  element.querySelectorAll('[data-theme-control]').forEach(function (el) {
    ...
    if (inputDataAttributeValue === 'navbarStyle' && !hasDataUrl
  ...
  themeController.on('click', function (e) {
    ...
    if (target.data('theme-control')) {
      ...
      switch (control) {
           ...
           */
        case 'theme': {
          document.documentElement.classList[value === 'dark' ? 'add'
              : 'remove']('dark');
        ...
        case 'navbarPosition': {
          ...
          if (navbarPosition === 'top') {
            ...
            navbarTopVertical.classList.add('d-none')
            navbarVertical.classList.add('d-none')
            navbarTopCombo.classList.add('d-none')
            navbarTop.classList.remove('d-none')

            navbarVertical.classList.remove('navbar-vertical navbar-expand-xl')
            ...
            navbarVertical.classList.remove('d-none')
            navbarTopCombo.classList.remove('d-none')
            ...
            navbarVertical.classList.remove('d-none')
            navbarTopVertical.classList.remove('d-none')

            navbarVertical.classList.add('navbar-vertical navbar-expand-xl')
            navbarTop.classList.add('d-none navbar-vertical navbar-expand-xl')
...
var wizardInit = function wizardInit() {
  ...
  wizards.forEach(function (wizard) {
    ...
    nextButton.addEventListener('click', function () {
      if ((!(inputEmail.value && validatePattern(emailPattern,
          inputEmail.value)) || !inputPassword.value
          || !inputConfirmPassword.value) && form.className.includes(
          'needs-validation')) {
        form.classList.add('was-validated');
      } else {
        count += 1;
...
var events = [{
  ...
  title: 'Conference',
  start: "".concat(currentYear, "-").concat(currentMonth, "-").concat(
      currentDay),
  ...
  description: "ICT Expo ".concat(currentYear,
...
var appCalendarInit = function appCalendarInit() {
  ...
  var eventList = events.reduce(function (acc, val) {
    return val.schedules ? acc.concat(val.schedules.concat(val)) : acc.concat(
        val);
  }, []);
  ...
  if (appCalendar) {
    var calendar = renderCalendar(appCalendar, {
      ...
      eventClick: function eventClick(info) {
        if (info.event.url) {
          ...
          document.querySelector(
              Selectors.EVENT_DETAILS_MODAL_CONTENT).innerHTML = template;
      ...
      dateClick: function dateClick(info) {
        ...
        var flatpickr = document.querySelector(
            Selectors.EVENT_START_DATE)._flatpickr;
    ...
    document.querySelectorAll(Selectors.DATA_CALENDAR_VIEW).forEach(
        function (link) {
          link.addEventListener(Events.CLICK, function (e) {
            e.preventDefault();
            var el = e.currentTarget;
            var text = el.textContent;
            el.parentElement.querySelector(Selectors.ACTIVE).classList.remove(
                ClassNames.ACTIVE);
            el.classList.add(ClassNames.ACTIVE);
            document.querySelector(
                Selectors.DATA_VIEW_TITLE).textContent = text;
    ...
    addEventForm && addEventForm.addEventListener(Events.SUBMIT, function (e) {
      ...
      calendar.addEvent({
        ...
        className: allDay.checked && label.value ? "bg-soft-".concat(
            label.value) : '',
...
var getStackIcon = function getStackIcon(icon, transform) {
  return "\n      <span class=\"fa-stack ml-n1 mr-3\">\n        <i class=\"fas fa-circle fa-stack-2x text-200\"></i>\n        <i class=\"".concat(
      icon, " fa-stack-1x text-primary\" data-fa-transform=").concat(transform,
      "></i>\n      </span>\n    ");
};

var getTemplate = function getTemplate(info) {
  return "\n  <div class=\"modal-header bg-light ps-card pe-5 border-bottom-0\">\n    <div>\n      <h5 class=\"modal-title mb-0\">".concat(
      info.event.title, "</h5>\n      ").concat(
      info.event.extendedProps.organizer
          ? "<p class=\"mb-0 fs--1 mt-1\">\n          by <a href=\"#!\">".concat(
          info.event.extendedProps.organizer, "</a>\n        </p>") : '',
      ...
      "\n      <div class=\"flex-1\">\n          <h6>Date and Time</h6>\n          <p class=\"mb-1\">\n            ").concat(
      window.dayjs && window.dayjs(info.event.start).format(
      'dddd, MMMM D, YYYY, h:mm A'), " \n            ").concat(
      info.event.end ? "\u2013 <br/>".concat(
          window.dayjs && window.dayjs(info.event.end).subtract(1,
          'day').format('dddd, MMMM D, YYYY, h:mm A')) : '',
      "\n          </p>\n      </div>\n    </div>\n    ").concat(
    ...
    return {
      ...
      data: {
        ...
        datasets: [{
          label: '# of Votes',
          data: [12, 19, 3, 5, 6, 3],
          backgroundColor: [utils.rgbaColor(utils.getColor('secondary'), 0.2),
          ...
          borderColor: [utils.getColor('secondary'), utils.getColor('warning'),
            utils.getColor('info'), utils.getColor('success'),
            utils.getColor('info'), utils.getColor('primary')],
          borderWidth: 1
        }]
      },
      options: {
  ...
  var getOptions = function getOptions() {
    return {
      ...
      data: {
        datasets: [{
          data: [5, 3, 2, 1, 1],
          backgroundColor: [utils.rgbaColor(utils.getColor('facebook'), 0.2),
          ...
          borderWidth: 1,
          // borderColor:'black'
          borderColor: [utils.getColor('facebook'), utils.getColor('youtube'),
            utils.getColor('twitter'), utils.getColor('linkedin'),
...
var chartLinePaymentInit = function chartLinePaymentInit() {
  ...
  -----------------------------------------------*/
  var chartData = [3, 1, 4, 1, 5, 9, 2, 6, 5, 3, 5, 8, 9, 7, 9, 3, 2, 3, 8, 4,
    6, 2, 6, 4, 3, 3, 8, 3, 2, 7, 9, 5, 0, 2, 8, 8, 4, 1, 9, 7];
  var labels = ['9:00 AM', '10:00 AM', '11:00 AM', '12:00 PM', '1:00 PM',
  ...
  if (chartLine) {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor: localStorage.getItem('theme') === 'dark'
              ? utils.getColors().primary : utils.settings.chart.borderColor,
        ...
        tooltips: {
          ...
          callbacks: {
            label: function label(tooltipItem) {
              return "".concat(labels[tooltipItem.index], " - ").concat(
                  tooltipItem.yLabel, " USD");
            },
    ...
    (_document$querySelect = document.querySelector('#dashboard-chart-select'))
    === null || _document$querySelect === void 0 ? void 0
        : _document$querySelect.addEventListener('change', function (e) {
          var LineDB = {
  ...
  var getOptions = function getOptions() {
    return {
      ...
      data: {
        datasets: [{
          data: [5, 3, 2, 1, 1],
          backgroundColor: [utils.rgbaColor(utils.getColor('facebook'), 0.75),
  ...
  var getOptions = function getOptions() {
    return {
      ...
      data: {
        datasets: [{
          data: [10, 20, 50, 40, 30],
          backgroundColor: [utils.rgbaColor(utils.getColor('facebook'), 0.5),
    ...
    var realTimeUserChart = utils.newChart(realTimeUser, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [183, 163, 176, 172, 166, 161, 164, 159, 172, 173, 184, 163, 99,
...
var echartSetOption = function echartSetOption(chart, userOptions,
    getDefaultOptions) {
...
var navbarVerticalToggle = document.querySelector('.navbar-vertical-toggle');
navbarVerticalToggle && navbarVerticalToggle.addEventListener(
    'navbar.vertical.toggle', function () {
      return resizeEcharts();
    });
/* -------------------------------------------------------------------------- */
...
var marketShare = function marketShare() {
  ...
  if ($echartMarketShare) {
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        color: [utils.getColors().primary, utils.getColors().info,
          utils.getGrays()[300]],
        tooltip: {
          trigger: 'item',
          padding: [7, 10],
          ...
          formatter: function formatter(params) {
            return "<strong>".concat(params.data.name, ":</strong> ").concat(
                params.percent, "%");
          }
        },
...
var topProducts = function topProducts() {
  ...
  if ($echartBarTopProducts) {
    var data = [['product', '2019', '2018'], ['Boots4', 43, 85],
      ['Reign Pro', 83, 73], ['Slick', 86, 62], ['Falcon', 72, 53],
      ['Sparrow', 80, 50], ['Hideway', 50, 70], ['Freya', 80, 90] // ['Raven Pro', 60, 70],
      // ['Posh', 80, 70],
    ];
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        tooltip: {
          ...
          formatter: function formatter(params) {
            return "<div class=\"font-weight-semi-bold\">".concat(
                params.seriesName,
                "</div><div class=\"fs--1 text-600\"><strong>").concat(
                params.name, ":</strong> ").concat(
...
var totalSales = function totalSales() {
  ...
  if ($echartsLineTotalSales) {
    ...
    var monthsnumber = [[60, 80, 60, 80, 65, 130, 120, 100, 30, 40, 30, 70],
    ...
    var getDefaultOptions = function getDefaultOptions() {
      return {
        ...
        xAxis: {
          type: 'category',
          data: ['2019-01-05', '2019-01-06', '2019-01-07', '2019-01-08',
          ...
          axisLabel: {
            ...
            formatter: function formatter(value) {
              ...
              return "".concat(months[date.getMonth()], " ").concat(
                  date.getDate());
            },
            margin: 15
          }
